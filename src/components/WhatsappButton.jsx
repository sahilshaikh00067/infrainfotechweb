...
const WhatsappButton = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] shadow-2xl flex items-center justify-center"
    >
