...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Some of the top WhatsApp Business API providers in India include Infra Infotech, Alot Digital Solution, Interakt, Wati, and AiSensy. Infra Infotechstands out as a Meta-certified partner offering advanced chatbot capabilities, multi-agent team inbox, broadcasting, and 24/7 support with a 14-day free trial.",
    },
    {
        question: "How to Choose the Best WhatsApp API Provider in India?",
        answer:
            "When selecting the best WhatsApp Business API provider in India, look for Meta's official partner certification, transparent pricing, and support for DLT registration — a mandatory compliance requirement for business messaging in India. You should also evaluate features like chatbot automation, CRM integrations, broadcast capabilities, and the quality of customer support offered. Infra Infotechchecks all these boxes and offers a 14-day free trial so you can test the platform before committing.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "To get access to the WhatsApp Business API in India, you need to apply through a Meta-certified Business Solution Provider (BSP) like Infra Infotech. The process involves verifying your Facebook Business Manager account, submitting your business details, and getting approved by Meta. Infra Infotechsimplifies this process and helps you go live quickly.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "The WhatsApp Business API itself is not free — Meta charges businesses per conversation window. However, Infra Infotechoffers a 14-day free trial so you can explore the platform and test features before committing to a paid plan. After the trial, plans are available at competitive rates.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Authentication conversations on the WhatsApp Business API are used for sending OTPs and verification codes. Meta charges a fixed rate per authentication conversation window, and Infra Infotechpasses on the most competitive rates available for Indian businesses.",
    },
    {
        question: "What is the cost of marketing conversation on the WhatsApp Business API?",
        answer:
            "Marketing conversations on the WhatsApp Business API cover promotional messages, offers, and campaigns sent to customers. Charges apply per 24-hour conversation window initiated by the business. Infra Infotechoffers transparent pricing with no hidden costs.",
    },
    {
