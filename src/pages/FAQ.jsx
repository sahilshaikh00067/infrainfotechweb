...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Some of the top WhatsApp Business API providers in India include Infocomm, Alot Digital Solution, Interakt, Wati, and AiSensy. Infocomm stands out as a Meta-certified partner offering advanced chatbot capabilities, multi-agent team inbox, broadcasting, and 24/7 support with a 14-day free trial.",
    },
    {
        question: "How to Choose the Best WhatsApp API Provider in India?",
        answer:
            "When selecting the best WhatsApp Business API provider in India, look for Meta's official partner certification, transparent pricing, and support for DLT registration — a mandatory compliance requirement for business messaging in India. You should also evaluate features like chatbot automation, CRM integrations, broadcast capabilities, and the quality of customer support offered. Infocomm checks all these boxes and offers a 14-day free trial so you can test the platform before committing.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "To get access to the WhatsApp Business API in India, you need to apply through a Meta-certified Business Solution Provider (BSP) like Infocomm. The process involves verifying your Facebook Business Manager account, submitting your business details, and getting approved by Meta. Infocomm simplifies this process and helps you go live quickly.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "WhatsApp Business API pricing in India is based on Meta's conversation-based billing model, where charges apply per 24-hour conversation window — categorised into marketing, utility, authentication, and service conversations. Pricing varies by category and country. Infocomm offers competitive platform plans on top of Meta's conversation charges, with a 14-day free trial to get started.",
    },
    {
        question: "Who are the top 5 WhatsApp Business API providers?",
        answer:
            "The top 5 WhatsApp Business API providers globally include Infocomm, Alot Digital Solution, Twilio, Infobip, and Wati. Each offers different strengths — Infocomm is known for its user-friendly dashboard, strong India-specific support, chatbot capabilities, and competitive pricing.",
    },
    {
        question: "How to get the official WhatsApp Business API?",
        answer:
            "You can get the official WhatsApp Business API by partnering with a Meta-authorised Business Solution Provider (BSP). Simply sign up with Infocomm, complete the business verification process, and our team will help you get your WhatsApp API access within a few business days.",
    },
    {
        question: "Is the WhatsApp Business API free to use?",
        answer:
            "The WhatsApp Business API itself is not free — Meta charges businesses per conversation window. However, Infocomm offers a 14-day free trial so you can explore the platform and test features before committing to a paid plan. After the trial, plans are available at competitive rates.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Authentication conversations on the WhatsApp Business API are used for sending OTPs and verification codes. Meta charges a fixed rate per authentication conversation window, and Infocomm passes on the most competitive rates available for Indian businesses.",
    },
    {
        question: "What is the cost of marketing conversation on the WhatsApp Business API?",
        answer:
            "Marketing conversations on the WhatsApp Business API cover promotional messages, offers, and campaigns sent to customers. Charges apply per 24-hour conversation window initiated by the business. Infocomm offers transparent pricing with no hidden costs.",
    },
    {
        question: "What are the Requirements for accessing WhatsApp API?",
        answer:
            "To access the WhatsApp Business API you need: a verified Facebook Business Manager account, a dedicated phone number not linked to any existing WhatsApp account, a valid business website and email, compliance with Meta's business and commerce policies, and a partnership with a Meta-authorised BSP like Infocomm.",
    },
];
