...
export default function TermsOfService() {
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* HERO */}
      <div className="bg-gradient-to-r from-[#1a2b6b] to-[#1d4ed8] py-16 px-6 md:px-16 text-center">
        <h1 className="text-4xl md:text-5xl font-semibold text-white">Terms and Conditions</h1>
        <p className="mt-4 text-blue-200 text-base">Last updated: 2025</p>
      </div>

      {/* CONTENT */}
      <div className="max-w-4xl mx-auto px-6 md:px-10 py-16 text-gray-700 text-[15px] leading-relaxed space-y-10">

        {/* Welcome */}
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Welcome to Shivangi Desai</h2>
          <p>
            These terms and conditions outline the rules and regulations for the use of{" "}
            <span className="font-semibold text-gray-900">Shivangi Desai</span>'s Website,
          ...
          <p className="mt-4">
            ...
            Shivangi Desaiif you do not agree to take all of the terms and conditions stated on this page.
          </p>
          <p className="mt-4">
            ...
            of provision of the Company's stated services, in accordance with and subject to, prevailing law of India. Any use of the above
        ...
        <div>
          ...
          <p>
            We employ the use of cookies. By accessing Shivangi Desai, you agreed to use cookies in agreement
            with Shivangi Desai's Privacy Policy.
          </p>
          <p className="mt-4">
            ...
            to enable the functionality of certain areas to make it easier for people visiting our website. Some of our
        ...
        <div>
          ...
          <p>
            Unless otherwise stated, Shivangi Desaiand/or its licensors own the intellectual property rights for all
            material on Shivangi Desai. All intellectual property rights are reserved. You may access this from
            Shivangi Desaifor your own personal use subjected to restrictions set in these terms and conditions.
          </p>
          ...
          <ul className="mt-3 space-y-2 list-disc list-inside text-gray-600">
            <li>Republish material from Shivangi Desai</li>
            <li>Sell, rent or sub-license material from Shivangi Desai</li>
            <li>Reproduce, duplicate or copy material from Shivangi Desai</li>
            <li>Redistribute content from Shivangi Desai</li>
          </ul>
          <p className="mt-4">
          ...
          <p className="mt-4">
            ...
            website. Shivangi Desaidoes not filter, edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of Shivangi Desai, its agents and/or affiliates.
            ...
            laws, Shivangi Desaishall not be liable for the Comments or for any liability, damages or expenses caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
          </p>
          <p className="mt-4">
            Shivangi Desaireserves the right to monitor all Comments and to remove any Comments which can be considered
          ...
          <p className="mt-4">
            You hereby grant Shivangi Desaia non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <div>
          ...
          <p>
            ...
            Shivangi Desaiand its controlled subsidiaries without your permission. Please be aware that this privacy
            ...
            in the context of other, separately operated, Shivangi Desaiproducts or services.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Shivangi Desaiwill store all the personal information you provide on its secure servers. Information
        ...
        <div>
          ...
          <p>
            Information that Shivangi Desaicollects may be stored and processed in and transferred between any of the
            countries in which Shivangi Desaioperates to enable the use of the information in accordance with this
        ...
        <div>
          ...
          <p className="mt-4">
            ...
            to us from the visibility of the hyperlink compensates the absence of Shivangi Desai; and (d) the link is
            in the context of general resource information.
          </p>
          <p className="mt-4">
            If you are one of the organizations listed above and are interested in linking to our website, you must inform us by sending
            an e-mail to{" "}
            <a href="mailto:support@infrainfotech.com" className="text-blue-600 hover:underline">support@infrainfotech.com</a>.
            Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs
            from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3
          ...
          <p className="mt-4">
            No use of Shivangi Desai's logo or other artwork will be allowed for linking absent a trademark license agreement.
          </p>
        </div>
        ...
        {/* iFrames */}
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">iFrames</h2>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any
            third party rights.
          </p>
        </div>
        ...
        <div>
          ...
          <p>Please read our <a href="/privacy-policy" className="text-blue-600 hover:underline font-semibold">Privacy Policy</a>.</p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and its linking
        ...
        <div>
          ...
          <p>
            Unless mandated by law or agreed otherwise in writing, paid Subscriptions are non-cancellable and non-refundable. No refunds
            or credits (service or otherwise) will be issued for partial periods of Service, upgrade/downgrade requests, or unused
            portions of Service.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            When you visit Shivangi Desaiwebsite, Shivangi Desaimay ask you some information.
            When you fill such information, it will be presumed that you wish to communicate with Shivangi Desai
            and give consent to Shivangi Desaito receive communications from Shivangi Desai.
          </p>
          <p className="mt-4">
            Shivangi Desaiwill communicate with you through e-mail or Call or by posting notices on the Site or
            by such other means as Shivangi Desaimay determine from time-to-time. You agree that all agreements,
            notices, disclosures and other communications that Shivangi Desaiprovides to you satisfy any legal
        ...
        <div>
          ...
          <p>
            You hereby agree to defend, indemnify and hold Shivangi Desaiagainst any and all losses, liabilities,
        ...
        {/* Third-Party Sites */}
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">Third-Party Sites</h2>
          <p>
            ...
            such Third-Party sites, which may be different from these T&C or Shivangi Desai's Privacy Policy.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            Shivangi Desaiin connection with the Services, shall constitute the entire agreement between you and
            Shivangi Desaiconcerning the Services. If any provision of these T&C is deemed invalid, illegal or
        ...
        <div>
          ...
          <p>
            ...
            Shivangi Desaican assign such rights and licenses without restriction.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            These T&C will be construed and enforced in all respects in accordance with the laws of India. Your use of this website
            and any dispute arising out of such use of the website is subject to the laws of India.
          </p>
        </div>
        ...
        {/* Jurisdiction */}
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">Jurisdiction</h2>
          <p>
            ...
            provided however, that Shivangi Desaimay seek to enforce any judgment in its favor in any court of competent
            jurisdiction. Notwithstanding the foregoing, Shivangi Desaimay seek injunctive or other equitable relief
            ...
            breach of these T&C may result in immediate and irreparable damage to Shivangi Desaifor which there is no
        ...
        <div>
          ...
          <p className="mt-4">
            ...
            on the website. Unauthorized use of this website may give rise to a claim for damages and/or be a criminal offence.
          </p>
        </div>
        ...
        {/* Updation */}
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">Updation of T&C</h2>
          <p>
            These T&C may be revised from time to time and the updated version will always be posted on the Website. If you do not
            agree to the new T&C, you will stop accessing the website.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-6">
          ...
          <p className="text-gray-600">
            ...
            <a href="mailto:support@infrainfotech.com" className="text-blue-600 hover:underline font-semibold">
